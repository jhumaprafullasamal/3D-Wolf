  ...
  return (
    ...
    <main>
      ...
      <section id='section-3'>
        <div className="top">
          <div className="left">
          <h1>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, quaerat.</h1>
          </div>
          <div className="right"></div>
        </div>
        <div className="bottom">
          <div className="left"></div>
          {/* <div className="right">
            <p>Lorem ipsum dolor sit amet consectetur <br /> adipisicing elit. Porro sed sint <br />velit facere consequuntur nostrum.</p>
            <p>Lorem ipsum dolor, sit amet<br /> consectetur adipisicing elit. Esse quidem<br /> nisi vero voluptatibus. Sint,<br /> distinctio nostrum.</p>
          </div> */}
        </div>
      </section>
